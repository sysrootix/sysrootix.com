(() => {
  ...
  const I18N = {
    ru: {
      ...
      aboutText: "Я — sysrootix, full-stack разработчик из Хабаровска. Собираю продукты целиком: витрина, мобильное приложение, бэкенд на Rust и Node, CRM, интеграции с 1С — и сам держу серверы и выкладку. А ещё маркетинг: лендинги, боты, промо и аналитика, чтобы продукт дошёл до людей.",
      fact1: "хабаровск · дом",
      ...
      mdaText: "платформа для сети магазинов: лояльность, бронь в магазине, telegram mini app, админка, приложение и лендинги. рядом — RootDesk, общий inbox обращений.",
      ...
      cuText: "меню-бар macOS: остаток лимитов AI-инструментов",
    ...
    en: {
      ...
      aboutText: "I'm sysrootix, a full-stack developer from Khabarovsk. I build products end to end: storefront, mobile app, Rust and Node backends, CRM, 1C integrations — and I run the servers and deploys myself. Plus marketing: landing pages, bots, promos and analytics, so the product actually reaches people.",
      ...
      mdaText: "a platform for a store chain: loyalty, in-store booking, telegram mini app, admin, app and landing pages. plus RootDesk, a shared inbox for requests.",
      ...
      cuText: "macOS menu bar: remaining limits of your AI tools",
