(() => {
  ...
  const I18N = {
    ru: {
      ...
      aboutText: "Я — sysrootix. Full-stack разработчик из Хабаровска. Пишу фронтенд и бэкенд, сам поднимаю и настраиваю серверы — по сути devops, — а ещё занимаюсь маркетингом: умею не только собрать продукт, но и довести его до людей.",
      fact1: "хабаровск · дом",
      fact2: "обычно на связи",
      fact3: "код · серверы · маркетинг",
      ...
      phrases: ["full-stack / devops / marketing", "пишу фронт и бэк", "поднимаю серверы в 3 ночи", "запускаю и продвигаю продукты", "режу баги катаной"],
      city: {
    ...
    en: {
      ...
      aboutText: "I'm sysrootix — a full-stack developer from Khabarovsk. I build frontends and backends, set up and run my own servers (devops, basically) and do marketing too: I can not only build a product but also get it in front of people.",
      fact1: "khabarovsk · home",
      fact2: "usually online",
      fact3: "code · servers · marketing",
      ...
      phrases: ["full-stack / devops / marketing", "shipping front and back", "spinning up servers at 3am", "launching and growing products", "slicing bugs with a katana"],
      city: {
